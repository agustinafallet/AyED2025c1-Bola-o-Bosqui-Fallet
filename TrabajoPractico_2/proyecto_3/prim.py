...
def prim(G, inicio):
    ...
    while not cp.estaVacio():
        ...
        for vertice_siguiente in vertice_actual.obtener_conexiones():
            nuevo_costo = vertice_actual.obtener_distancia() + vertice_actual.obtener_ponderacion(vertice_siguiente)            # comienza función de relajación
